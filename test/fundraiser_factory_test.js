...
contract("FundraiserFactory: fundraisers", (accounts) => {
  ...
  describe("varying limits", () => {
    ...
    it("returns 10 results when limit required is 10", async () => {
      const fundraisers = await factory.fundraisers(10, 0);
      assert.equal(
        fundraisers.length,
        10,
    ...
    it("returns 20 results when limit required is 20", async () => {
    ...
    it("returns 20 results when limit required is 30", async () => {
